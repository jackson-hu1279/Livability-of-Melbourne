...
file_name1 = "results-distress.json"
...
with open(file_name1) as f:
    ...
    for data in dataset["greater_melbourne"]:
        ...
        distress_count = data["distress_count"]
        distress_rate = data["distress_rate"]
        lga_distress_count[lga_code] = distress_count
        lga_distress_rate[lga_code] = distress_rate
...
with open(file_name2) as f:
    ...
    for data in dataset["features"]:
        ...
        if lga_name in greater_melbourne_lga_name:
            ...
            data["properties"] = {
                "lga_code": lga_code, "lga_name": lga_name, "distress_count": lga_distress_count[lga_code],
                "distress_rate": lga_distress_rate[lga_code]}
